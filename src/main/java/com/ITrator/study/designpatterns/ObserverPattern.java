...
public class ObserverPattern 
{
	public static void main(String[] args) {
		...
		Subscriber s1 = new Subscriber("Krishna");
		Subscriber s2 = new Subscriber("Mohan");
		Subscriber s3 = new Subscriber("Lal");
		Subscriber s4 = new Subscriber("Keshari");
		Subscriber s5 = new Subscriber("Sippu");
		...
		telusko.updload("How to learn programming ");
